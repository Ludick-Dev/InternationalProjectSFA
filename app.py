...
@app.route('/')
def index():
    return render_template('Dileep-design.html', letter=letter, video_capture_started=video_capture_started)
...
@app.route('/start_video_capture', methods=['POST'])
def start_video_capture():
    global video_capture_started
    if not video_capture_started:
